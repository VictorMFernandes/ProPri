...
namespace ProPri.Autorizacao.Dados.Mapeamentos
{
    ...
    {
        internal const string Tabela = "tb_role";
        ...
        public void Configure(EntityTypeBuilder<IdentityRole> b)
        {
            ...
            b.Property(u => u.Name).HasMaxLength(AutorizacaoConst.TamanhoPerfilNomeMax);
            b.Property(u => u.NormalizedName).HasMaxLength(AutorizacaoConst.TamanhoPerfilNomeMax);
